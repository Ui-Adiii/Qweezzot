        ...
        {loading ? (
            ...
            >
              <CarouselContent className="-ml-2 md:-ml-4">
                {filteredLatestProducts.map((product, index) => {
                  ...
                  return (
                    <CarouselItem key={product._id} className="pl-2 md:pl-4 basis-full sm:basis-1/2 lg:basis-1/3 xl:basis-1/4">
                      <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                      ...
                      >
                        <Card
                          className="group relative bg-white/80 backdrop-blur-sm border border-emerald-200/50 rounded-2xl shadow-soft hover:shadow-xl transition-all duration-500 hover:-translate-y-2 overflow-hidden cursor-pointer h-full flex flex-col"
                          ...
                          <div className="relative h-48 bg-gradient-to-br from-emerald-50 to-teal-50 overflow-hidden">
                            ...
                            <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-all duration-300 flex items-center justify-center">
                              <div className="opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 flex gap-2">
                                ...
                                <Button 
                                  size="sm" 
                                  className="rounded-full bg-emerald-500 hover:bg-emerald-600 text-white border-0 shadow-lg"
                          ...
                          <CardContent className="pt-6 pb-4 flex-1 flex flex-col">
                            ...
                            <div className="mb-3">
                              <Badge className={cn(
                                ...
                                product.category.toLowerCase() === "health" && "bg-emerald-100/70 text-emerald-800 ring-1 ring-emerald-300/30 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-amber-500 hover:text-white hover:ring-amber-400/30",
                                product.category.toLowerCase() === "men" && "bg-blue-100/70 text-blue-800 ring-1 ring-blue-300/30 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-amber-500 hover:text-white hover:ring-amber-400/30",
                                product.category.toLowerCase() === "women" && "bg-pink-100/70 text-pink-800 ring-1 ring-pink-300/30 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-amber-500 hover:text-white hover:ring-amber-400/30",
                                product.category.toLowerCase() === "kids" && "bg-lime-100/70 text-lime-800 ring-1 ring-lime-300/30 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-amber-500 hover:text-white hover:ring-amber-400/30",
                                "bg-gray-100/70 text-gray-800 ring-1 ring-gray-300/30 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-amber-500 hover:text-white hover:ring-amber-400/30"
                              )}>
                            ...
                            {/* Product Name */}
                            <h3 className="text-lg font-bold text-gray-900 group-hover:text-emerald-700 transition-colors duration-300 mb-2 line-clamp-2 min-h-[3.5rem]">
                              {product.name}
                            </h3>
                            ...
                            <Button 
                              size="sm" 
                              className="w-full rounded-full bg-emerald-500 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-amber-500 text-white border-0 group/btn transition-all duration-300"
              ...
              <CarouselPrevious className="absolute left-2 md:-left-12 top-1/2 -translate-y-1/2 h-10 w-10 md:h-12 md:w-12 rounded-full bg-white/95 backdrop-blur-xl border-2 border-emerald-200/50 text-emerald-700 hover:bg-gradient-to-r hover:from-emerald-500 hover:to-amber-500 hover:text-white hover:border-0 shadow-2xl ring-2 ring-amber-400/20 transition-all duration-300 z-30 disabled:opacity-30 disabled:cursor-not-allowed hover:scale-110 active:scale-95" />
          ...
          <div className="text-center py-16">
            ...
            <Button 
              ...
              className="rounded-full border-emerald-200 text-emerald-700 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-amber-500 hover:text-white hover:border-transparent transition-all duration-300"
            >
              View All Products
            </Button>
          </div>
        ...
        <div className="text-center mt-12">
          ...
          >
            <Button 
              variant="outline" 
              size="lg" 
              className="rounded-full px-8 border-2 border-emerald-200 text-emerald-700 hover:bg-gradient-to-r hover:from-emerald-600 hover:to-amber-500 hover:text-white hover:border-transparent bg-white/80 backdrop-blur-sm ring-1 ring-amber-400/10 transition-all duration-300"
