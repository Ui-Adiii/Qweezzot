...
const CTASection = () => {
  return (
    <section className="relative py-24 bg-gradient-to-br from-blue-900 via-blue-800 to-teal-900 text-white overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-100 text-sm font-medium mb-8 backdrop-blur-sm">
        ...
        <p className="text-xl md:text-2xl mb-10 opacity-95 max-w-3xl mx-auto leading-relaxed font-light">
          ...
          <span className="text-blue-200 font-medium">Believe in yourself</span>{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto mb-12">
          {[
            ...
            <div key={index} className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-blue-200 mb-2">
                {stat.number}
              </div>
        ...
        <Button
          asChild
          className="group relative bg-gradient-to-r from-blue-500 to-teal-600 hover:from-blue-400 hover:to-teal-500 text-white px-12 py-6 rounded-2xl font-semibold text-lg shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 hover:scale-105 active:scale-95 border-0"
          size="lg"
        >
          <Link to="/join">
        ...
        {/* Trust Indicator */}
        <p className="text-blue-200/70 text-sm mt-8 flex items-center justify-center gap-2">
