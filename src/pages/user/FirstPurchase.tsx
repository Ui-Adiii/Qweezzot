      ...
      if (walletData.purchaseWallet < finalPrice) {
        toast.error(
          `Insufficient wallet balance. You need ₹${(
            finalPrice - walletData.purchaseWallet
          ).toFixed(2)} more.`
        );
          ...
          <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {products.slice(0, visibleCount).map((product, index) => {
                    ...
                    const hasEnoughBalance =
                      walletData.purchaseWallet >= finalPrice;
                        ...
                        <Card className="group relative border-sky-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden ring-1 ring-amber-400/10 h-full flex flex-col">
                          ...
                          <CardContent className="p-0">
                            ...
                            <div className="relative h-56 bg-gradient-to-br from-sky-50/70 to-amber-50/50 overflow-hidden flex-shrink-0">
                              {product.images && product.images.length > 0 ? (
                                ...
                                <div className="flex justify-center h-full items-center">
                                  <div className="p-3 bg-gradient-to-br from-blue-100/70 to-amber-100/50 rounded-lg backdrop-blur-sm ring-1 ring-amber-300/20">
                            ...
                            <div className="p-6 space-y-3 flex-1 flex flex-col">
                              {/* Category Badge */}
                              <div>
                                <Badge className="bg-blue-100/70 text-blue-800 ring-1 ring-blue-300/30 backdrop-blur-sm text-xs">
                                  {product.category.charAt(0).toUpperCase() +
                                    product.category.slice(1)}
                                </Badge>
                              </div>

                              <h3 className="text-lg font-semibold text-blue-800 line-clamp-2 min-h-[3.5rem]">
                                {product.name}
                              </h3>
            ...
            >
              ...
              <p className="text-amber-700 text-sm">
                Your first purchase activates your account and qualifies you for
                the compensation plan. Choose the package that best fits your
                goals and budget. You can pay using your purchase wallet
                balance.
              </p>
            </motion.div>
          </CardContent>
