          ...
          <CardContent>
            {loading ? (
                  ...
                  >
                    <CardContent className="p-4">
                      <div className="flex justify-between items-center">
                        <div className="flex items-center space-x-3">
                          <div className="w-10 h-10 bg-sky-200/50 rounded-lg"></div>
                          <div className="space-y-2">
                            <div className="h-4 bg-sky-200/50 rounded w-32"></div>
                            <div className="h-3 bg-sky-200/50 rounded w-48"></div>
                          </div>
                        </div>
              ...
              <div className="text-center py-12 text-sky-700/70">
                <CreditCard className="h-16 w-16 text-sky-300 mx-auto mb-4" />
                            ...
                            <div
                              className={`p-2 rounded-lg backdrop-blur-sm ${
                                transaction.type === "credit"
                                  ? "bg-sky-100/70 ring-1 ring-sky-300/30"
