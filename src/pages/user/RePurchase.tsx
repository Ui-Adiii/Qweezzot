      ...
      if (response.success && response.data) {
        ...
        orders.forEach((order) => {
          order.items.forEach((item) => {
            ...
            if (
              !existing ||
              new Date(order.createdAt) > new Date(existing.lastPurchasedDate)
            ) {
        ...
        <Card className="border-sky-200/50 bg-white/70 backdrop-blur-xl shadow-lg ring-1 ring-amber-400/10">
          <CardHeader>
            ...
            <p className="text-sm text-gray-600 mt-2">
              Repurchase products you've bought before (from any order) to
              maintain your active status and continue earning.
            </p>
          </CardHeader>
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  You haven't made any repurchase orders yet. Your previously
                        ...
                        <div className="space-y-2 mb-4 flex-1">
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="font-medium">
                              {formatDate(product.lastPurchasedDate)}
                            </span>
                          </div>
                          <div className="flex items-center justify-between text-sm">
                            <span className="text-gray-600">
            ...
            <Card className="border-amber-200/50 bg-gradient-to-br from-amber-50/70 to-yellow-50/50 backdrop-blur-sm rounded-lg ring-1 ring-amber-400/10">
              <CardContent className="p-4">
                ...
                <ul className="text-sky-800 text-sm space-y-1">
                  ...
                  <li>
                    • Get package-specific cashback (₹4,200 - ₹20,000 based on
                    your package)
                  </li>
