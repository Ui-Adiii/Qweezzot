        ...
        >
          <Card className="border-blue-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-blue-700 mb-2">₹12,500</p>
        ...
        >
          <Card className="border-blue-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-blue-700 mb-2">₹8,750</p>
              <p className="text-sm text-blue-800 font-medium">Welcome Bonus</p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div
        ...
        >
          <Card className="border-blue-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-blue-700 mb-2">₹5,000</p>
              <p className="text-sm text-blue-800 font-medium">
                Leadership Bonus
              </p>
            </CardContent>
        ...
        >
          <Card className="border-blue-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-blue-700 mb-2">₹15,000</p>
              <p className="text-sm text-blue-800 font-medium">
                Achievement Bonus
              </p>
            </CardContent>
                    ...
                    <CardContent className="p-4">
                      <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-sm text-blue-700/70">Bonus</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
