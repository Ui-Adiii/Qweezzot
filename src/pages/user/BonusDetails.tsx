    ...
    <div className="p-6 space-y-6 bg-gradient-to-br from-emerald-50/30 via-white to-emerald-50/20 min-h-screen">
        ...
        >
          <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-emerald-700 mb-2">₹12,500</p>
              <p className="text-sm text-emerald-800 font-medium">Matching Bonus</p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div
        ...
        >
          <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-emerald-700 mb-2">₹8,750</p>
              <p className="text-sm text-emerald-800 font-medium">Welcome Bonus</p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div
        ...
        >
          <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-emerald-700 mb-2">₹5,000</p>
              <p className="text-sm text-emerald-800 font-medium">Leadership Bonus</p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div
        ...
        >
          <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-2xl font-bold text-emerald-700 mb-2">₹15,000</p>
              <p className="text-sm text-emerald-800 font-medium">Achievement Bonus</p>
            </CardContent>
          </Card>
        </motion.div>
      </div>
      ...
      >
        <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg ring-1 ring-amber-400/10">
          <CardHeader>
            <CardTitle className="text-xl text-emerald-900">Bonus Breakdown</CardTitle>
          </CardHeader>
          <CardContent>
                    ...
                    <CardContent className="p-4">
                      <div className="flex justify-between items-start">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <h3 className="font-bold text-emerald-900">{bonus.type}</h3>
                            <p className="text-sm text-emerald-800">{bonus.description}</p>
                            <p className="text-xs text-emerald-700 mt-1">{bonus.date}</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="font-bold text-lg text-emerald-700">+₹{bonus.amount.toLocaleString()}</p>
                          <p className="text-sm text-emerald-700/70">Bonus</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
