    ...
    <div className="p-6 space-y-6 bg-gradient-to-br from-emerald-50/30 via-white to-emerald-50/20 min-h-screen">
      ...
      >
        <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg ring-1 ring-amber-400/10">
          <CardHeader>
            <CardTitle className="text-xl text-emerald-900">Monthly Subscription Plans</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            >
              <Card className="border-emerald-200/50 bg-white/60 backdrop-blur-md rounded-lg ring-1 ring-amber-400/10">
                <CardContent className="p-4 flex items-center justify-between">
                  <div>
                    <p className="font-bold text-emerald-900">Next Monthly Purchase</p>
                    <p className="text-emerald-700">Due: December 15, 2024</p>
                  </div>
              ...
              >
                <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-lg font-bold text-emerald-900 mb-2">Basic Monthly</h3>
                    <p className="text-2xl font-bold text-emerald-700 mb-2">₹500</p>
                    <p className="text-sm text-emerald-700 mb-4">per month</p>
              ...
              >
                <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-lg font-bold text-emerald-900 mb-2">Standard Monthly</h3>
                    <p className="text-2xl font-bold text-emerald-700 mb-2">₹1,000</p>
                    <p className="text-sm text-emerald-700 mb-4">per month</p>
                    <Button className="w-full bg-gradient-to-r from-emerald-600 to-amber-500 hover:from-emerald-700 hover:to-amber-600 text-white shadow-lg ring-1 ring-amber-300/30">
                      <Clock className="h-4 w-4 mr-2" />
                      Subscribe
              ...
              >
                <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-lg font-bold text-emerald-900 mb-2">Premium Monthly</h3>
                    <p className="text-2xl font-bold text-emerald-700 mb-2">₹2,000</p>
                    <p className="text-sm text-emerald-700 mb-4">per month</p>
                    <Button className="w-full bg-gradient-to-r from-emerald-600 to-amber-500 hover:from-emerald-700 hover:to-amber-600 text-white shadow-lg ring-1 ring-amber-300/30">
                      <Clock className="h-4 w-4 mr-2" />
                      Subscribe
            ...
            >
              <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg ring-1 ring-amber-400/10">
                <CardContent className="p-4">
                  <h4 className="font-bold text-emerald-900 mb-2">Monthly Purchase Benefits:</h4>
