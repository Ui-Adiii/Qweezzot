        ...
        >
          <Card className="border-sky-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              {loading ? (
                <div className="h-8 bg-sky-200/50 rounded animate-pulse mx-auto w-24 mb-2"></div>
              ) : (
        ...
        >
          <Card className="border-sky-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-sky-800 font-medium">This Month</p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div
        ...
        >
          <Card className="border-sky-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-sky-800 font-medium">This Week</p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div
        ...
        >
          <Card className="border-sky-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-sky-800 font-medium">Today</p>
            </CardContent>
          </Card>
        </motion.div>
      </div>
            ...
            {loading ? (
              <div className="space-y-4">
                {[...Array(5)].map((_, i) => (
                  <Card
                    key={i}
                    className="border-sky-200/50 bg-white/60 backdrop-blur-md animate-pulse"
                  >
                        ...
                        <div className="flex justify-between items-center">
                          <div className="flex-1">
                            <div className="flex items-center space-x-3 mb-2">
                              <Badge className="bg-sky-100/70 text-sky-800 ring-1 ring-sky-300/30 backdrop-blur-sm">
