    ...
    <div className="p-6 space-y-6 bg-gradient-to-br from-emerald-50/30 via-white to-emerald-50/20 min-h-screen">
        ...
        >
          <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              {loading ? (
                <div className="h-8 bg-emerald-200/50 rounded animate-pulse mx-auto w-24 mb-2"></div>
              ) : (
                <p className="text-2xl font-bold text-emerald-700 mb-2">
                  {formatCurrency(incomeData.stats.totalIncome)}
                </p>
              )}
              <p className="text-sm text-emerald-800 font-medium">Total Earnings</p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div
        ...
        >
          <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-emerald-800 font-medium">This Month</p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div
        ...
        >
          <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-emerald-800 font-medium">This Week</p>
            </CardContent>
          </Card>
        </motion.div>
        <motion.div
        ...
        >
          <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-sm text-emerald-800 font-medium">Today</p>
            </CardContent>
          </Card>
        </motion.div>
      </div>
      ...
      >
        <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg ring-1 ring-amber-400/10">
          <CardHeader>
            <CardTitle className="text-xl text-emerald-900">Income Records</CardTitle>
          </CardHeader>
          <CardContent>
            {loading ? (
              <div className="space-y-4">
                {[...Array(5)].map((_, i) => (
                  <Card key={i} className="border-emerald-200/50 bg-white/60 backdrop-blur-md animate-pulse">
                        ...
                        <div className="flex justify-between items-center">
                          <div className="flex-1">
                            <div className="flex items-center space-x-3 mb-2">
                              <Badge className="bg-emerald-100/70 text-emerald-800 ring-1 ring-emerald-300/30 backdrop-blur-sm">
                            ...
                            <p className="font-bold text-emerald-900">{record.description}</p>
