    ...
    <div className="p-6 space-y-6 bg-gradient-to-br from-emerald-50/30 via-white to-emerald-50/20 min-h-screen">
      ...
      >
        <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg ring-1 ring-amber-400/10">
          <CardHeader>
            <CardTitle className="text-xl text-emerald-900">Accelerate Your Success</CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
              ...
              >
                <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
                  <CardContent className="p-6">
                    <motion.div
                      className="p-3 bg-gradient-to-br from-emerald-500/20 to-amber-500/20 rounded-xl backdrop-blur-sm ring-1 ring-amber-300/30 w-fit mb-4"
                      whileHover={{ rotate: 360 }}
                      transition={{ duration: 0.6 }}
                    >
                      <Rocket className="h-12 w-12 text-emerald-600" />
                    </motion.div>
                    <h3 className="text-lg font-bold text-emerald-900 mb-2">Quick Start Program</h3>
                    <p className="text-2xl font-bold text-emerald-700 mb-4">₹15,000</p>
              ...
              >
                <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
                  <CardContent className="p-6">
                    ...
                    <h3 className="text-lg font-bold text-emerald-900 mb-2">Elite Fast Track</h3>
                    <p className="text-2xl font-bold text-emerald-700 mb-4">₹50,000</p>
                    <ul className="text-sm text-emerald-800 space-y-2 mb-4">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              >
                <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
                  <CardContent className="p-4 text-center">
                    <h4 className="font-bold text-emerald-900 mb-2">Fast Ranking</h4>
                    <p className="text-emerald-800 text-sm">Achieve higher ranks in weeks, not months</p>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              >
                <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
                  <CardContent className="p-4 text-center">
                    <h4 className="font-bold text-emerald-900 mb-2">Expert Mentorship</h4>
                    <p className="text-emerald-800 text-sm">Learn from top performers in the industry</p>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              >
                <Card className="border-emerald-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
                  <CardContent className="p-4 text-center">
                    <h4 className="font-bold text-emerald-900 mb-2">Premium Resources</h4>
                    <p className="text-emerald-800 text-sm">Access exclusive tools and materials</p>
                  </CardContent>
                </Card>
              </motion.div>
            </div>
