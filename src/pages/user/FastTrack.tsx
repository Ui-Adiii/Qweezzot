              ...
              >
                <Card className="border-sky-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
                  <CardContent className="p-6">
                    <motion.div
                      className="p-3 bg-gradient-to-br from-sky-500/20 to-amber-500/20 rounded-xl backdrop-blur-sm ring-1 ring-amber-300/30 w-fit mb-4"
                    ...
                    <ul className="text-sm text-sky-800 space-y-2 mb-4">
                ...
                <Card className="border-sky-200/50 bg-white/70 backdrop-blur-xl shadow-lg hover:shadow-2xl transition-all duration-300 ring-1 ring-amber-400/10 hover:ring-amber-400/30">
                  <CardContent className="p-6">
                    <motion.div
                      ...
                      transition={{ duration: 0.6 }}
                    >
                      <Target className="h-12 w-12 text-sky-600" />
                    </motion.div>
                    <h3 className="text-lg font-bold text-sky-900 mb-2">
                      Elite Fast Track
                    </h3>
